...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):                     # Required to validate new posts
        form.instance.author = self.request.user    # New post author = user creating post
        return super().form_valid(form)             # Validate post
