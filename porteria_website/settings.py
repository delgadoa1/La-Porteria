"""
Django settings for porteria_website project.
...
SECRET_KEY = '!l$2otcy)fm1$!k_bltr8h$33(0l(#)23v-o=w=oei3-epd016'
...
ROOT_URLCONF = 'porteria_website.urls'
...
WSGI_APPLICATION = 'porteria_website.wsgi.application'
